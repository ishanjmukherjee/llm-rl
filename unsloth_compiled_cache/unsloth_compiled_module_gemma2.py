...
from typing import Any, List, Optional, Tuple, Union, Dict, Set, Callable
from transformers.models.gemma2.modeling_gemma2 import (Callable, Optional, Union, torch, nn, ACT2FN, Cache, GenerationMixin, FlashAttentionKwargs, BaseModelOutputWithPast, CausalLMOutputWithPast, ROPE_INIT_FUNCTIONS, dynamic_rope_update, ALL_ATTENTION_FUNCTIONS, PreTrainedModel, Unpack, can_return_tuple, Gemma2Config, logger, __name__, Gemma2PreTrainedModel, Gemma2Model, Gemma2ForCausalLM)
...
class Gemma2RMSNorm(nn.Module):
    ...
    def forward(self, x):
        return Gemma2RMSNorm_forward(self, x)
...
class Gemma2MLP(nn.Module):
    ...
    def forward(self, x):
        return Gemma2MLP_forward(self, x)
...
class Gemma2Attention(nn.Module):
    ...
    def forward(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        return Gemma2Attention_forward(self, hidden_states, position_embeddings, attention_mask, past_key_value, cache_position, **kwargs)


@torch.compile(fullgraph = True, dynamic = True, options = torch_compile_options)
@torch.no_grad()
@dynamic_rope_update  # power user: used with advanced RoPE types (e.g. dynamic rope)
def Gemma2RotaryEmbedding_forward(self, x, position_ids):
...
class Gemma2RotaryEmbedding(nn.Module):
    ...
    def forward(self, x, position_ids):
        return Gemma2RotaryEmbedding_forward(self, x, position_ids)
...
class Gemma2ForCausalLM(Gemma2PreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs,
        ...
        return Gemma2ForCausalLM_forward(self, input_ids, attention_mask, position_ids, past_key_values, inputs_embeds, labels, use_cache, output_attentions, output_hidden_states, cache_position, logits_to_keep, **kwargs)
